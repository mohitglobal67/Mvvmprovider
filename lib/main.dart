...
import 'package:mvvm/repository/branch_api/branch_http_api_perp.dart';
...
import 'package:mvvm/view/branch/branch_view.dart';
...
void main() {
  ...
  getIt.registerLazySingleton<BranchRepository>(() => BranchHttpApiRepository());
  runApp(const MyApp());
}
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(
            create: (_) => BranchViewViewModel(branchRepository: getIt())),
      ],
      child: MaterialApp(
        title: 'Flutter Demo',
        theme: ThemeData(
